package org.neptrueworks.irishyperion.dispatch.security.authentication;
...
public class JsonWebTokenAuthenticationToken extends AbstractAuthenticationToken {
    ...
    /**
     * The credentials that prove the principal is correct. This is usually a credential,
     ...
     * request with username and credential, this would be the username. Callers are
